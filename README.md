...
![GitHub commit activity](https://img.shields.io/github/commit-activity/w/DearJasker/FDPClient)
![GitHub code size in bytes](https://img.shields.io/github/languages/code-size/DearJasker/FDPClient)
![GitHub lines of code](https://tokei.rs/b1/github/DearJasker/FDPClient)
...
1. Clone the repository using `git clone https://github.com/DearJasker/FDPClient.git`. 
